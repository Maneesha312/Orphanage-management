...
(5, 'PARIVARAN - change of direction', 'The program is meant to bring about positive changed in the life of street children by convincing and motivating them and their parents for the education of their children and helping them in their school admission and other financial assistance if required.'),
...
ALTER TABLE `orphan`.`sponsorer` DROP PRIMARY KEY, ADD PRIMARY KEY (`spn_id`, `spn_phone`(10)) USING BTREE;
